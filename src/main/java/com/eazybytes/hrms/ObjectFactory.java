 ...
 * generated in the com.eazybytes.hrms package. 
...
public class ObjectFactory {
    ...
    private final static QName _RemoveEmployeeRequest_QNAME = new QName("http://eazybytes.com/hrms", "RemoveEmployeeRequest");
    private final static QName _GetEmployeeRequest_QNAME = new QName("http://eazybytes.com/hrms", "GetEmployeeRequest");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://eazybytes.com/hrms", "GetEmployeeResponse");
    private final static QName _GetAllEmployeesRequest_QNAME = new QName("http://eazybytes.com/hrms", "GetAllEmployeesRequest");
    private final static QName _GetAllEmployeeResponse_QNAME = new QName("http://eazybytes.com/hrms", "GetAllEmployeeResponse");
    private final static QName _RemoveEmployeeResponse_QNAME = new QName("http://eazybytes.com/hrms", "RemoveEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.eazybytes.hrms
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "RemoveEmployeeRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "GetEmployeeRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "GetEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "GetAllEmployeesRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "GetAllEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eazybytes.com/hrms", name = "RemoveEmployeeResponse")
